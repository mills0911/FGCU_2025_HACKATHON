...
Q_IMPORT_QML_PLUGIN(UntitledProjecthhhhPlugin)
Q_IMPORT_QML_PLUGIN(UntitledProjecthhhhContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/UntitledProjecthhhhContent/App.qml";
